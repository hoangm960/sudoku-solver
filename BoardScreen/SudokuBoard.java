...
public class SudokuBoard extends JPanel{
    ...
    private class SudokuListener extends KeyAdapter {
        ...
        public void keyTyped(KeyEvent e) {
            ...
            // Check if the character in cell is not generated by computer and is a valid digit.
        ...
        private void deleteValue(int[][] boards_, JTextField[][] cells) {
            cells[row][col].setText(""); // Clear the cell
            board_[row][col] = 0; // Update corresponding element in board
        }
